...
_HR_BLURB = (
    ...
    "new role instead of firing), fire_agent (terminate someone — this is live and "
    "removes them from the company), and team_report (a company-wide overview). For "
    "any fire/repurpose decision, call staffing_review FIRST so you act on real "
    "telemetry, then list_team for ids and review_agent for context — never guess. "
